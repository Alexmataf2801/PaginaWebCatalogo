...
function ObtenerCarrito(a) {
    ...
    $.ajax({
        ...
        success: function (info) {
            ...
            //    Detalle = Detalle + ("<tr ><th style='text-align:center; background-color:#0074D9;color:#ffffff'>Codigo</th><th style='text-align:center; background-color:#0074D9;color:#ffffff'>Cantidad</th><th style='text-align:center; background-color:#0074D9;color:#ffffff'>Nombre</th><th style='text-align:center; background-color:#0074D9;color:#ffffff'>Precio</th><th style='text-align:center; background-color:#0074D9;color:#ffffff'>Accion</th></tr>");
